...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/customer/WAG/mai.pkb-arc   2.0   Mar 07 2008 15:31:50   smarshall  $
--       Module Name      : $Workfile:   mai.pkb  $
--       Date into SCCS   : $Date:   Mar 07 2008 15:31:50  $
--       Date fetched Out : $Modtime:   Mar 07 2008 15:27:46  $
--       SCCS Version     : $Revision:   2.0  $
--       Based on PVCS Version     : 2.0
--
...
--        RETURN 'wor_agency = SYS_CONTEXT('''||g_context||''',''AGENCY'')';
        RETURN 'wor_agency = '''||SYS_CONTEXT('ICB_WAG','AGENCY')||'''';
      END IF;
END;
*/
...
FUNCTION ICB_WO_FGAC_PREDICATE(schema_in VARCHAR2,
  ...
  --
BEGIN
  lc_dummy:= mai.get_context ('ICB_WAG', 'AGENCY');
  if lc_dummy is null then
    return null;
  else
    RETURN 'wor_agency = '''||lc_dummy||'''';
  end if;  
END;
