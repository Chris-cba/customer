...
BEGIN
--
   l_rec_nlf.nlf_unique           := 'TWIS001NWTRA';
--
...
--
   upd_nlcd ('TIL_SCHEME_TYPE','TWIS001NWTRA.TIL_SCHEME_TYPE');
   upd_nlcd ('TIL_ROUTE_NUMBER','TWIS001NWTRA.TIL_ROUTE_NUMBER');
   upd_nlcd ('TIL_SCHEME_NUMBER','TWIS001NWTRA.TIL_SCHEME_NO');
   upd_nlcd ('TIL_DESCRIPTION','TWIS001NWTRA.TIL_DESCRIPTION');
   upd_nlcd ('TIL_APPROVED_CODE','TWIS001NWTRA.TIL_APPROVED_CODE');
   upd_nlcd ('TIL_AGENCY',''||CHR(39)||'14'||CHR(39)||'');
--
