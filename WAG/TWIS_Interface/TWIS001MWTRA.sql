...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/WAG/TWIS_Interface/TWIS001MWTRA.sql-arc   3.1   Oct 13 2009 10:08:38   Ian Turnbull  $
--       Module Name      : $Workfile:   TWIS001MWTRA.sql  $
...
BEGIN
--
   l_rec_nlf.nlf_unique           := 'TWIS001MWTRA';
--
...
--
   upd_nlcd ('TIL_SCHEME_TYPE','TWIS001MWTRA.TIL_SCHEME_TYPE');
   upd_nlcd ('TIL_ROUTE_NUMBER','TWIS001MWTRA.TIL_ROUTE_NUMBER');
   upd_nlcd ('TIL_SCHEME_NUMBER','TWIS001MWTRA.TIL_SCHEME_NO');
   upd_nlcd ('TIL_DESCRIPTION','TWIS001MWTRA.TIL_DESCRIPTION');
   upd_nlcd ('TIL_APPROVED_CODE','TWIS001MWTRA.TIL_APPROVED_CODE');
   upd_nlcd ('TIL_AGENCY',''||CHR(39)||'0012'||CHR(39)||'');
--
