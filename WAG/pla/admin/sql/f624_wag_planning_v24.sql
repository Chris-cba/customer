...
--
--application/shared_components/logic/application_processes/get_mapviewer_host_url
...
declare
    ...
    l_length number := 1;
begin
p:=p||':MAPVIEWER_HOST_URL := HIG.GET_SYSOPT(''PAPBASEURL'');';

wwv_flow_api.create_flow_process(
  p_id => 2171322452858037 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_process_sequence=> 1,
  p_process_point => 'BEFORE_HEADER',
  p_process_type=> 'PLSQL',
  p_process_name=> 'get_MAPVIEWER_HOST_URL',
  p_process_sql_clob=> p,
  p_process_error_message=> 'MAPVIEWER_HOST_URL not defined, check product option',
  p_process_when=> '',
  p_process_when_type=> '',
...
--application/shared_components/logic/application_items/mapviewer_host_url
 
begin
 
wwv_flow_api.create_flow_item(
  p_id=> 2171105830853267 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'MAPVIEWER_HOST_URL',
  p_data_type=> 'VARCHAR',
  p_is_persistent=> 'Y',
...
begin
h := null;
ph:=ph||'<script language="JavaScript" src="&MAPVIEWER_HOST_URL./fsmc/jslib/oraclemaps.js"></script>'||chr(10)||
