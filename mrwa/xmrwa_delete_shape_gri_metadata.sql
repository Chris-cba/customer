...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)xmrwa_delete_shape_gri_metadata.sql	1.1 03/15/05
--       Module Name      : xmrwa_delete_shape_gri_metadata.sql
--       Date into SCCS   : 05/03/15 00:45:31
...
--
   ...
   l_rec_grm.grm_pre_process :=            'BEGIN'
                                ||CHR(10)||'   -- @(#)xmrwa_delete_shape_gri_metadata.sql	1.1 03/15/05'
                                ||CHR(10)||'   DELETE FROM '||higgis.get_spatial_table
                                ||CHR(10)||'   WHERE '||higgis.get_spatial_pk_column||' = :XNM0105_NE_ID;'
                                ||CHR(10)||'   COMMIT;'
                                ||CHR(10)||'END;';
--
   l_rec_hmo.hmo_module            := l_rec_grm.grm_module;
   l_rec_hmo.hmo_title             := 'Delete Element Shape';
...
--
   l_rec_gp.gp_param           := 'XNM0105_NE_ID';
...
--
   ...
   l_rec_gmp.gmp_seq               := 1;
   l_rec_gmp.gmp_param_descr       := 'Datum Name';
