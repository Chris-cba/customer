CREATE OR REPLACE  VIEW X_NHCC_TMA_FWDPLAN_NRSWA_SDO AS
SELECT
--
-----------------------------------------------------------------------------
--
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/northants/permiting_themes/X_NHCC_TMA_FWDPLAN_NRSWA_SDO.vw-arc   1.0   Dec 07 2010 08:41:44   Ian.Turnbull  $
--       Module Name      : $Workfile:   X_NHCC_TMA_FWDPLAN_NRSWA_SDO.vw  $
...
-----------------------------------------------------------------------------
    ...
    WHERE     twor_org_ref = org_ref
          ...
          AND ( tphs_proposed_start_date < to_date('01102011', 'MMDDYY') 
                    OR ( x_nhswm_permited_street(twor_str_ne_id) != 1 and tphs_proposed_start_date > to_date('01102011', 'MMDDYY')));
                    
delete from user_sdo_geom_metadata 
   where table_name = 'X_NHCC_TMA_FWDPLAN_NRSWA_SDO';
   
insert into user_sdo_geom_metadata
   select 'X_NHCC_TMA_FWDPLAN_NRSWA_SDO', column_name, diminfo, SRID
