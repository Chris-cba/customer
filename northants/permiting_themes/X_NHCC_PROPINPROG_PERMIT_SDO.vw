CREATE OR REPLACE FORCE VIEW X_NHCC_PROPINPROG_PERMIT_SDO AS
SELECT
--
-----------------------------------------------------------------------------
--
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/northants/permiting_themes/X_NHCC_PROPINPROG_PERMIT_SDO.vw-arc   1.0   Dec 07 2010 08:41:42   Ian.Turnbull  $
--       Module Name      : $Workfile:   X_NHCC_PROPINPROG_PERMIT_SDO.vw  $
...
delete from user_sdo_geom_metadata 
   where table_name = 'X_NHCC_PROPINPROG_PERMIT_SDO';
   
insert into user_sdo_geom_metadata
   select 'X_NHCC_PROPINPROG_PERMIT_SDO', column_name, diminfo, SRID
