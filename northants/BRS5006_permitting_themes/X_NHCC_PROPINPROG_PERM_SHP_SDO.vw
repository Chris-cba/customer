CREATE OR REPLACE FORCE VIEW X_NHCC_PROPINPROG_PERM_SHP_SDO AS
SELECT
--
-----------------------------------------------------------------------------
--
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/northants/BRS5006_permitting_themes/X_NHCC_PROPINPROG_PERM_SHP_SDO.vw-arc   1.0   May 10 2011 09:08:50   Ian.Turnbull  $
--       Module Name      : $Workfile:   X_NHCC_PROPINPROG_PERM_SHP_SDO.vw  $
--       Date into PVCS   : $Date:   May 10 2011 09:08:50  $
--       Date fetched Out : $Modtime:   Apr 26 2011 10:38:14  $
...
-- this views contains all the PROPOSED IN PROGRESS phases that are  permited
...
delete from user_sdo_geom_metadata 
   where table_name = 'X_NHCC_PROPINPROG_PERM_SHP_SDO';
   
insert into user_sdo_geom_metadata
   select 'X_NHCC_PROPINPROG_PERM_SHP_SDO', column_name, diminfo, SRID
