CREATE OR REPLACE FUNCTION X_GET_MID_POINT( GEOM SDO_GEOMETRY ) RETURN SDO_GEOMETRY DETERMINISTIC 
--
--
-----------------------------------------------------------------------------
--
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/customer/northants/admin/pck/X_GET_MID_POINT.fnc-arc   3.0   Sep 17 2009 14:09:08   Ian Turnbull  $
--       Module Name      : $Workfile:   X_GET_MID_POINT.fnc  $
--       Date into PVCS   : $Date:   Sep 17 2009 14:09:08  $
--       Date fetched Out : $Modtime:   Sep 17 2009 12:00:42  $
--       PVCS Version     : $Revision:   3.0  $
--
--
--   Author : AILEEN HEAL
--
--   FUNCTION X_GET_MID_POINT( GEOM SDO_GEOMETRY )
--
-----------------------------------------------------------------------------
--	Copyright (c) exor corporation ltd, 2009
-----------------------------------------------------------------------------
--
-- This function was written by Aileen Heal for Northants as part of SoW 10621 to 
-- calculate the mid point of a TMA_RESTRICTION geometry using the folowing algorithm. 
--
