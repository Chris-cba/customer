...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)xtnz_lar_hct_ial_maint_trg.old.trg	1.1 03/15/05
--       Module Name      : xtnz_lar_hct_ial_maint_trg.old.trg
--       Date into SCCS   : 05/03/15 03:46:04
...
BEGIN
   ...
   l_rec_ial_new.ial_value       := :NEW.hct_id;
