CREATE OR REPLACE function x_wilt_str_insp_get_extent( p_item IN STR_INSP_LINES.SIL_CMP_SIT_ID%TYPE
                                                     , p_sip_id IN STR_INSP_LINES.SIL_SIP_ID%TYPE
                                                      ) return STR_INSP_LINES.sil_extent%TYPE
as
--
-----------------------------------------------------------------------------
--
--   PVCS Identifiers :-
--
--       pvcsid            : $Header:   //vm_latest/archives/customer/Wiltshire/disco_bridge_insp/x_wilt_str_insp_get_extent.fnc-arc   1.0   Oct 10 2012 09:16:24   Ian.Turnbull  $
--       Module Name      : $Workfile:   x_wilt_str_insp_get_extent.fnc  $
