...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/HA/insp_scheduling/install/inst.sql-arc   1.0   Jun 06 2012 16:23:34   Ian.Turnbull  $
--       Module Name      : $Workfile:   inst.sql  $
--       Date into PVCS   : $Date:   Jun 06 2012 16:23:34  $
--       Date fetched Out : $Modtime:   Apr 17 2012 14:33:10  $
...
select decode(upper('&ok_res'),'Y','&exor_base'||'insp_scheduling'||'&terminator'||
        'install'||'&terminator'||'insp_scheduling_install','exit') run_file
from dual
/
