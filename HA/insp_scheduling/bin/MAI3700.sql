...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/HA/insp_scheduling/bin/MAI3700.sql-arc   1.0   Jun 06 2012 16:22:34   Ian.Turnbull  $
--       Module Name      : $Workfile:   MAI3700.sql  $
--       Date into PVCS   : $Date:   Jun 06 2012 16:22:34  $
--       Date fetched Out : $Modtime:   Jun 06 2012 14:30:38  $
...
prompt Generate Inspections by Interval
prompt ================================
prompt
prompt 
prompt Generate Inspections by Interval
...
declare
   ...
   l_asset_type          varchar2(255);
   l_insp_type           varchar2(255);
   l_region_of_interest  varchar2(255);
   l_from_date           DATE;
   l_to_date             DATE;
...
begin
   ...
   higgrirp.write_gri_spool(&1,'Schedule has been submitted to Process Manager.');
