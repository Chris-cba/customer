CREATE OR REPLACE FORCE VIEW V_X_HA_ENQ_CLOSED_SDO
(
   DOC_ENQUIRY_ID,
   DOC_STATUS,
   DOC_SOURCE,
...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/customer/HA/themes/V_X_HA_ENQ_CLOSED_SDO.vw-arc   1.0   Jun 26 2012 11:46:20   Ian.Turnbull  $
--       Module Name      : $Workfile:   V_X_HA_ENQ_CLOSED_SDO.vw  $
--       Date into PVCS   : $Date:   Jun 26 2012 11:46:20  $
--       Date fetched Out : $Modtime:   Jun 21 2012 18:15:40  $
...
-----------------------------------------------------------------------------
-- view written by Aileen Heal to add the enq completed data so we only include 
...
--   
    ...
    WHERE doc.doc_dcl_code IS NOT NULL
	  ...
	  AND doc.DOC_DTP_CODE NOT IN ('INCI','INDN')	  
/

insert into user_sdo_geom_metadata (TABLE_NAME, COLUMN_NAME, DIMINFO, SRID )
select 'V_X_HA_ENQ_CLOSED_SDO', COLUMN_NAME, DIMINFO, SRID 
