CREATE OR REPLACE FORCE VIEW V_X_HA_INC_CLOSED_SDO
(
   DOC_ENQUIRY_ID,
   DOC_STATUS,
   DOC_SOURCE,
...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/customer/HA/themes/V_X_HA_INC_CLOSED_SDO.vw-arc   1.0   Jun 26 2012 11:46:24   Ian.Turnbull  $
--       Module Name      : $Workfile:   V_X_HA_INC_CLOSED_SDO.vw  $
--       Date into PVCS   : $Date:   Jun 26 2012 11:46:24  $
--       Date fetched Out : $Modtime:   Jun 21 2012 18:16:34  $
...
-- include incidents closed more than 6 months ago.
--   
...
select 'V_X_HA_INC_CLOSED_SDO', COLUMN_NAME, DIMINFO, SRID 
