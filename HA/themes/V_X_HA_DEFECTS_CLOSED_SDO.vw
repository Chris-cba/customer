CREATE OR REPLACE FORCE VIEW V_X_HA_DEFECTS_CLOSED_SDO
(
   DEFECT_ID,
   DEFECT_ROAD_ID,
   DEFECT_ROAD_NAME,
...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/customer/HA/themes/V_X_HA_DEFECTS_CLOSED_SDO.vw-arc   1.0   Jun 26 2012 11:46:16   Ian.Turnbull  $
--       Module Name      : $Workfile:   V_X_HA_DEFECTS_CLOSED_SDO.vw  $
--       Date into PVCS   : $Date:   Jun 26 2012 11:46:16  $
...
-- defect by status spatial view so we can only include defects closed in the last 6 months.
--
...
select 'V_X_HA_DEFECTS_CLOSED_SDO', COLUMN_NAME, DIMINFO, SRID 
