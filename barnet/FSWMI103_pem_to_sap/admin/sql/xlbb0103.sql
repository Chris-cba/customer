...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/customer/barnet/FSWMI103_pem_to_sap/admin/sql/xlbb0103.sql-arc   2.0   Oct 15 2007 08:39:18   smarshall  $
--       Module Name      : $Workfile:   xlbb0103.sql  $
...
EXEC higgrirp.write_gri_spool('&1','');
prompt
EXEC higgrirp.write_gri_spool('&1','LBB Atlas PEM Invoice to SAP Extract');
...
BEGIN
  l_extract_filename := xlbb_pem_invoice.create_extract_file;
