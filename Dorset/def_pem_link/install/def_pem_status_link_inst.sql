...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/Dorset/def_pem_link/install/def_pem_status_link_inst.sql-arc   1.0   Sep 06 2011 16:23:16   Ian.Turnbull  $
--       Module Name      : $Workfile:   def_pem_status_link_inst.sql  $
--       Date into PVCS   : $Date:   Sep 06 2011 16:23:16  $
--       Date fetched Out : $Modtime:   Sep 06 2011 14:35:36  $
...
select decode(upper('&ok_res'),'Y','&exor_base'||'def_pem_link'||'&terminator'||
        'install'||'&terminator'||'def_pem_status_link_install','exit') run_file
from dual
/
