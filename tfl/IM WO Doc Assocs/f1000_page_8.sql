...
/* -----------------------------------------------------------------------------
 ...
 --   PVCS Identifiers :-
 --
 --       pvcsid           : $Header:   //vm_latest/archives/customer/tfl/IM WO Doc Assocs/f1000_page_8.sql-arc   1.0   Jun 18 2012 13:08:00   Ian.Turnbull  $
 --       Module Name      : $Workfile:   f1000_page_8.sql  $
 --       Date into PVCS   : $Date:   Jun 18 2012 13:08:00  $
 --       Date fetched Out : $Modtime:   Jun 18 2012 13:05:40  $
...
prompt  APPLICATION 1000 - im_framework
--
-- Application Export:
--   Application:     1000
--   Name:            im_framework
--   Date and Time:   11:26 Monday June 18, 2012
--   Exported By:     ADMIN
--   Flashback:       0
...
wwv_flow_api.create_page(
  ...
  p_help_text => ' ',
  p_html_page_header => '',
  p_step_template => 15695220996382425+ wwv_flow_api.g_id_offset,
  p_required_patch=> null + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'ADMIN',
  p_last_upd_yyyymmddhh24miss => '20120618112517',
...
wwv_flow_api.create_report_region (
  p_id=> 2189830873574425 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  ...
  p_translate_title=> 'Y',
  p_ajax_enabled=> 'Y',
  p_query_row_template=> 21029679435434298+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  p_id=> 2190830053576289 + wwv_flow_api.g_id_offset,
  p_region_id=> 2189830873574425 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2190914166576289 + wwv_flow_api.g_id_offset,
  p_region_id=> 2189830873574425 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2190002531574439 + wwv_flow_api.g_id_offset,
  p_region_id=> 2189830873574425 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2190114920574453 + wwv_flow_api.g_id_offset,
  p_region_id=> 2189830873574425 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 2190209242574453 + wwv_flow_api.g_id_offset,
  p_region_id=> 2189830873574425 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_item(
  p_id=>2190311732574453 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  p_name=>'P8_WOID',
  p_data_type=> 'VARCHAR',
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 2189830873574425+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>2190518612574468 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  ...
  p_field_alignment  => 'LEFT',
  p_field_template => 21045158761672303+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_lov_display_extra=>'NO',
  p_protection_level => 'N',
  p_item_comment => '');
