CREATE OR REPLACE FORCE VIEW XIMF_WO_TFL_WORK_TRAY_3
(
   WORKS_ORDER_NUMBER,
   DESCRIPTION,
   NUMBER_OF_LINES,
...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/tfl/wo_worktrays/admin/views/ximf_wo_tfl_work_tray_3.vw-arc   3.0   Oct 25 2010 10:21:32   Ian.Turnbull  $
--       Module Name      : $Workfile:   ximf_wo_tfl_work_tray_3.vw  $
