CREATE OR REPLACE FORCE VIEW X_S50_LICENCES_SD0PT 
(PHASE_ID, WORKS_ID, PHASE_NUMBER, PHASE_TYPE, PHASE_TYPE_NAME, 
 ...
 EXCAVATION_METHOD, EXCAVATION_METHOD_NAME, GEOMETRY, TPHS_ID)
AS
SELECT
--
------------------------------------------------------------------------------
...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/tfl/4 1 TMA Themes/X_S50_LICENCES_SD0PT.vw-arc   3.0   Nov 09 2009 11:39:34   iturnbull  $
--       Module Name      : $Workfile:   X_S50_LICENCES_SD0PT.vw  $
...
from imf_tma_phases  a, imf_tma_works b, TMA_PHASES_POINT_SDO C
where ACTIVE_FLAG = 'Y'
