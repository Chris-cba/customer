CREATE OR REPLACE VIEW X_WORKS_BY_NOTICING_AUTH_SDOPT
(PHASE_ID, WORKS_ID, PHASE_NUMBER, PHASE_TYPE, PHASE_TYPE_NAME, 
 ...
 EXCAVATION_METHOD, EXCAVATION_METHOD_NAME, ORGANISATION_REFERENCE, GEOMETRY, TPHS_ID)
AS 
SELECT
--
-----------------------------------------------------------------------------
...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/tfl/4 1 TMA Themes/X_WORKS_BY_NOTICING_AUTH_SDOPT.vw-arc   3.0   Nov 09 2009 11:39:34   iturnbull  $
--       Module Name      : $Workfile:   X_WORKS_BY_NOTICING_AUTH_SDOPT.vw  $
...
-----------------------------------------------------------------------------
--
     a."PHASE_ID",a."WORKS_ID",a."PHASE_NUMBER",a."PHASE_TYPE",a."PHASE_TYPE_NAME",
     a."ACTIVE_FLAG",a."PHASE_STATUS",a."PHASE_STATUS_NAME",a."WORKS_CATEGORY",
     a."WORKS_CATEGORY_NAME",a."DESCRIPTION",a."TRAFFIC_ORDER_APPLIES",a."WORKS_RESTRICTED",
     a."WORKS_RESTRICTED_NAME",a."ESTIMATED_END_DATE",a."LOCATION_DESCRIPTION",
     ...
     a."EXCAVATION_METHOD",a."EXCAVATION_METHOD_NAME",a."ORGANISATION_REFERENCE", b.TPPS_TPHS_GEOMETRY , b.TPPS_TPHS_ID
from X_WORKS_BY_NOTICING_AUTH a, TMA_PHASES_POINT_SDO b
