/* -----------------------------------------------------------------------------
 ...
 --   PVCS Identifiers :-
 --
 --       pvcsid           : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/Fix installs/im4_4500_tfl_fix1/admin/sql/x_im_wo_has_doc.sql-arc   1.0   Jan 14 2016 21:06:02   Sarah.Williams  $
 --       Module Name      : $Workfile:   x_im_wo_has_doc.sql  $
 --       Date into PVCS   : $Date:   Jan 14 2016 21:06:02  $
 --       Date fetched Out : $Modtime:   Jun 25 2012 17:08:36  $
