...
AS
   SELECT -------------------------------------------------------------------------
          --   PVCS Identifiers :-
          --
          --       PVCS id          : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/Fix installs/im4_4500_tfl_fix1/admin/views/imf_mai_work_orders_all_attrib.vw-arc   1.0   Jan 14 2016 21:06:34   Sarah.Williams  $
          --       Module Name      : $Workfile:   imf_mai_work_orders_all_attrib.vw  $
          --       Date into PVCS   : $Date:   Jan 14 2016 21:06:34  $
          --       Date fetched Out : $Modtime:   Feb 20 2013 00:49:46  $
