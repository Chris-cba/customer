 Create or replace view C_POD_EOT_REQUESTS as
 --
 With Haud as
    (SELECT HAUD_PK_ID HAUD_PK_ID, HAUD_INV_TYPE,
...
and ha.HAUD_ATTRIBUTE_NAME = 'WOR_DATE_ATTRIB121'
group by ha.haud_pk_id
 ...
 SELECT DISTINCT
          ...
          WOR.WOR_CHAR_ATTRIB75 AS "REASON FOR PRICING EXTENSION",
