...
AS
   SELECT -------------------------------------------------------------------------
                                                      --   PVCS Identifiers :-
                                                                            --
 --       PVCS id          : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/Existing PODS/IM4 tfl Post v45 scripts/scripts/XIMF_MAI_WORK_ORDERS_ALL_ATTR.sql-arc   1.0   Jan 14 2016 19:50:02   Sarah.Williams  $
 --       Module Name      : $Workfile:   XIMF_MAI_WORK_ORDERS_ALL_ATTR.sql  $
                  --       Date into PVCS   : $Date:   Jan 14 2016 19:50:02  $
               --       Date fetched Out : $Modtime:   Jan 16 2013 22:05:48  $
