...
AS
   SELECT -------------------------------------------------------------------------
                                                      --   PVCS Identifiers :-
                                                                            --
 --       PVCS id          : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/Existing PODS/IM4 tfl Post v45 scripts/scripts/XIMF_MAI_WORK_ORDER_LINES.sql-arc   1.0   Jan 14 2016 19:50:06   Sarah.Williams  $
       --       Module Name      : $Workfile:   XIMF_MAI_WORK_ORDER_LINES.sql  $
                  --       Date into PVCS   : $Date:   Jan 14 2016 19:50:06  $
               --       Date fetched Out : $Modtime:   Sep 24 2012 11:00:18  $
