   create or replace view c_pod_eot_updated as      
   --
   With Haud as
  ...
  SELECT DISTINCT
     ...
     FROM IMF_MAI_WORK_ORDERS_ALL_ATTRIB WOR,
          ...
          (  SELECT HAUD_PK_ID RA_HAUD_PK_ID, HAUD_ATTRIBUTE_NAME RA_HAUD_ATTRIBUTE_NAME, HAUD_TIMESTAMP RA_MAX_TS, HAUD_NEW_VALUE FROM HAUD) RA,  -- moved into With
    ...
    WHERE     WOR.WORKS_ORDER_NUMBER = WORK_ORDER_NUMBER
          ...
          --AND WOR_CHAR_ATTRIB101 = RA.HAUD_NEW_VALUE
