...
AS
   SELECT -------------------------------------------------------------------------
                                                      --   PVCS Identifiers :-
                                                                            --
 --       PVCS id          : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/LoHAC- Pod Updates/Work/Superseded/For Fix 7/admin/sql/ximf_mai_wo_all_attr_no_sec.sql-arc   1.0   Jan 15 2016 00:48:00   Sarah.Williams  $
 --       Module Name      : $Workfile:   ximf_mai_wo_all_attr_no_sec.sql  $
                  --       Date into PVCS   : $Date:   Jan 15 2016 00:48:00  $
