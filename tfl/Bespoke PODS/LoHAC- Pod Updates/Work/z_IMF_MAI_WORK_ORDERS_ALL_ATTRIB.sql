DROP VIEW HIGHWAYS.IMF_MAI_WORK_ORDERS_ALL_ATTRIB;
...
AS
   SELECT -------------------------------------------------------------------------
          --   PVCS Identifiers :-
          --
          --       PVCS id          : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/LoHAC- Pod Updates/Work/z_IMF_MAI_WORK_ORDERS_ALL_ATTRIB.sql-arc   1.0   Jan 14 2016 22:35:18   Sarah.Williams  $
          --       Module Name      : $Workfile:   z_IMF_MAI_WORK_ORDERS_ALL_ATTRIB.sql  $
          --       Date into PVCS   : $Date:   Jan 14 2016 22:35:18  $
          --       Date fetched Out : $Modtime:   Jan 26 2013 17:50:12  $
...
ALTER VIEW HIGHWAYS.IMF_MAI_WORK_ORDERS_ALL_ATTRIB
  DROP CONSTRAINT IMF_MAI_WORK_ORDERS_ALL_AT_FK1;

ALTER VIEW HIGHWAYS.IMF_MAI_WORK_ORDERS_ALL_ATTRIB
  DROP CONSTRAINT IMF_MAI_WORK_ORDERS_ALL_ATT_PK;
