...
AS
   SELECT -------------------------------------------------------------------------
                                                      --   PVCS Identifiers :-
                                                                            --
 --       PVCS id          : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/LoHAC- Pod Updates/Work/For Fix Breakout/wowt001_003/admin/sql/ximf_mai_wo_all_attr_no_sec.sql-arc   1.0   Jan 14 2016 23:09:06   Sarah.Williams  $
 --       Module Name      : $Workfile:   ximf_mai_wo_all_attr_no_sec.sql  $
                  --       Date into PVCS   : $Date:   Jan 14 2016 23:09:06  $
