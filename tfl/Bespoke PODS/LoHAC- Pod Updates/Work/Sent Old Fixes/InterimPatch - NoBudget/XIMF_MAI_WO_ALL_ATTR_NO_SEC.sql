...
AS
   SELECT -------------------------------------------------------------------------
                                                      --   PVCS Identifiers :-
                                                                            --
 --       PVCS id          : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/LoHAC- Pod Updates/Work/Sent Old Fixes/InterimPatch - NoBudget/XIMF_MAI_WO_ALL_ATTR_NO_SEC.sql-arc   1.0   Jan 15 2016 00:39:38   Sarah.Williams  $
 --       Module Name      : $Workfile:   XIMF_MAI_WO_ALL_ATTR_NO_SEC.sql  $
                  --       Date into PVCS   : $Date:   Jan 15 2016 00:39:38  $
