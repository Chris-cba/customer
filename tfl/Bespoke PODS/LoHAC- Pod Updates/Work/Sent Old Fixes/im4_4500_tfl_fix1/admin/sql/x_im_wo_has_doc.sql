/* -----------------------------------------------------------------------------
 ...
 --   PVCS Identifiers :-
 --
 --       pvcsid           : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/LoHAC- Pod Updates/Work/Sent Old Fixes/im4_4500_tfl_fix1/admin/sql/x_im_wo_has_doc.sql-arc   1.0   Jan 15 2016 00:26:16   Sarah.Williams  $
 --       Module Name      : $Workfile:   x_im_wo_has_doc.sql  $
 --       Date into PVCS   : $Date:   Jan 15 2016 00:26:16  $
 --       Date fetched Out : $Modtime:   Jun 25 2012 16:08:36  $
