...
AS
   SELECT -------------------------------------------------------------------------
                                                      --   PVCS Identifiers :-
                                                                            --
 --       PVCS id          : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/LoHAC- Pod Updates/Work/Sent Old Fixes/im4_4500_tfl_fix1/admin/views/ximf_mai_work_order_lines.vw-arc   1.0   Jan 15 2016 00:27:38   Sarah.Williams  $
       --       Module Name      : $Workfile:   ximf_mai_work_order_lines.vw  $
                  --       Date into PVCS   : $Date:   Jan 15 2016 00:27:38  $
