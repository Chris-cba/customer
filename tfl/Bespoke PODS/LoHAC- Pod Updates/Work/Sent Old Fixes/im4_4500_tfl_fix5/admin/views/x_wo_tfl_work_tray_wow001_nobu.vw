...
SELECT HAUD_PK_ID HAUD_PK_ID, HAUD_NIT_INV_TYPE,
                    ...
                    MAX (HAUD_TIMESTAMP) HAUD_TIMESTAMP, range_value, HAUD_NEW_VALUE
           ...
           GROUP BY HAUD_PK_ID, HAUD_ATTRIBUTE_NAME,HAUD_NIT_INV_TYPE, range_value, HAUD_NEW_VALUE
) 
--
...
--
 SELECT DISTINCT
     ...
     FROM XIMF_MAI_WO_ALL_ATTR_NO_SEC wor,
         ...
         -- haud2
    WHERE     1=1            
          AND wor.works_order_number = wol.wol_id(+)
