...
AS
   SELECT -------------------------------------------------------------------------
                                                      --   PVCS Identifiers :-
                                                                            --
 --       PVCS id          : $Header:   //new_vm_latest/archives/customer/tfl/Bespoke PODS/LoHAC- Pod Updates/Work/XIMF_MAI_WO_ALL_ATTR_NO_SEC.sql-arc   1.0   Jan 14 2016 22:34:32   Sarah.Williams  $
 --       Module Name      : $Workfile:   XIMF_MAI_WO_ALL_ATTR_NO_SEC.sql  $
                  --       Date into PVCS   : $Date:   Jan 14 2016 22:34:32  $
