...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/InfoMan/dorset/add_modules.sql-arc   3.1   Jan 20 2010 10:05:10   iturnbull  $
--       Module Name      : $Workfile:   add_modules.sql  $
--       Date into PVCS   : $Date:   Jan 20 2010 10:05:10  $
--       Date fetched Out : $Modtime:   Jan 19 2010 15:28:16  $
...
REM INSERTING into hig_modules
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM100211','Enquiries Type over time','100000:IM100211','WEB',null,'Y','N','IM',null);
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM100212','Enquiries Type over time Report','IM100212','WEB',null,'Y','N','IM',null);
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM100213','Enquiries','100000:IM100213','WEB',null,'Y','N','IM',null);
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM100214','Enquiries Report','IM100214','WEB',null,'Y','N','IM',null);
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM20210','FPN Offences by Works Promoter','20000:IM20210','WEB',null,'Y','N','IM',null);
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM20211','FPN Offences by Type and by Works Promoter','IM20211','WEB',null,'Y','N','IM',null);
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM40212','Defects passed or nearing completion','40000:IM40212','WEB',null,'Y','N','IM',null);
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM40213','Total number of available and instructed defects','40000:IM40213','WEB',null,'Y','N','IM',null);
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM40214','Incomplete Defects Report','40000:IM40214','WEB',null,'Y','N','IM',null);
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM40215','Defect Repair Times','40000:IM40215','WEB',null,'Y','N','IM',null);
Insert into hig_modules (HMO_MODULE,HMO_TITLE,HMO_FILENAME,HMO_MODULE_TYPE,HMO_FASTPATH_OPTS,HMO_FASTPATH_INVALID,HMO_USE_GRI,HMO_APPLICATION,HMO_MENU) values ('IM40216','Details of Defect Repair Times','40000:IM40216','WEB',null,'Y','N','IM',null);
