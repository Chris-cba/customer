...
delete from nm_members_all where nm_obj_type = 'OPBD';
commit;
delete from nm_inv_items_all where iit_inv_type = 'OPBD';
commit;
...
commit;
delete from nm_inv_type_attribs_all where ita_inv_type = 'OPBD';
commit;
delete from nm_inv_nw_all where nin_nit_inv_code = 'OPBD';
commit;
delete from nm_inv_types_all where nit_inv_type = 'OPBD';
