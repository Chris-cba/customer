...
--
   ...
   l_rec_nlf.nlf_descr            := 'CSV Loader for the METP';
...
--
   ...
   upd_nlcd ('IIT_INV_TYPE',''||CHR(39)||'METP'||CHR(39)||'');
   ...
   upd_nlcd ('IIT_CHR_ATTRIB26','METP_CSV.TYPE');
   upd_nlcd ('IIT_CHR_ATTRIB27','METP_CSV.ASSET_NAME');
   upd_nlcd ('IIT_CHR_ATTRIB28','METP_CSV.OWNER');
   upd_nlcd ('IIT_CHR_ATTRIB29','METP_CSV.CUSTODIAN');
   upd_nlcd ('IIT_CHR_ATTRIB30','METP_CSV.ROADWAY_EXTENT');
   upd_nlcd ('IIT_CHR_ATTRIB31','METP_CSV.UPDATE_CYCLE');
   upd_nlcd ('IIT_CHR_ATTRIB32','METP_CSV.ASSETS_TO_REVIEW');
   upd_nlcd ('IIT_CHR_ATTRIB33','METP_CSV.AFFECTED_PROGRAMS');
   upd_nlcd ('IIT_CHR_ATTRIB34','METP_CSV.REPORT_LEVEL');
   upd_nlcd ('IIT_CHR_ATTRIB35','METP_CSV.DOCUMENTATION');
   ...
   upd_nlcd ('IIT_CHR_ATTRIB66','METP_CSV.UPDATE_COMMENT');
