...
--
   ...
   l_rec_nlf.nlf_descr            := 'CSV Loader to load the HATT data';
...
--
   ...
   upd_nlcd ('IIT_INV_TYPE',''||CHR(39)||'HATT'||CHR(39)||'');
   ...
   upd_nlcd ('IIT_FOREIGN_KEY','xKTKY_hath_fk(HATT_CSV.TYPE)');
   ...
   upd_nlcd ('IIT_CHR_ATTRIB26','HATT_CSV.TYPE');
   upd_nlcd ('IIT_CHR_ATTRIB27','HATT_CSV.ATTRIBUTE');
   upd_nlcd ('IIT_CHR_ATTRIB28','HATT_CSV.ACCESS_GROUP');
