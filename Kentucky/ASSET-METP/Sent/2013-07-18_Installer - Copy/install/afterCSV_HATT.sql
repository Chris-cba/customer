declare
	cursor c1 is select * from nm_inv_type_attribs where 1=1 AND ita_INV_TYPE ||ITA_ATTRIB_NAME not in (select iit_chr_attrib26 || iit_chr_attrib27 from nm_inv_items where iit_inv_type = 'HATT');
