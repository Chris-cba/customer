...
Values
   ('SURF', 'IIT_CHR_ATTRIB27', 1, 'x_surf_lookup(''BD'',MRG.BD_SURFACE_TYPE)');
   
*/
insert into NM_MRG_ITA_DERIVATION (
NMID_ITA_INV_TYPE, NMID_ITA_ATTRIB_NAME, NMID_SEQ_NO, NMID_DERIVATION)
Values
   ('SURF', 'IIT_CHR_ATTRIB26', 2, 'MRG.BD_SURFACE_TYPE');
...
NMID_ITA_INV_TYPE, NMID_ITA_ATTRIB_NAME, NMID_SEQ_NO, NMID_DERIVATION)
Values
   ('SURF', 'IIT_NUM_ATTRIB18', 5, 'x_surf_lookup_n(MRG.PM_C1_PM_PAVETYPE, MRG.BD_SURFACE_TYPE)');
...
NMID_ITA_INV_TYPE, NMID_ITA_ATTRIB_NAME, NMID_SEQ_NO, NMID_DERIVATION)
Values
   ('SURF', 'IIT_CHR_ATTRIB29', 7, 'x_surf_lookup_m(MRG.PM_C1_PM_PAVETYPE, MRG.BD_SURFACE_TYPE)');
