...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/customer/General Scripts/tma_traffic_themes/TMA_PROP_IN_PROGRESS.sql-arc   1.1   May 24 2010 09:15:50   iturnbull  $
--       Module Name      : $Workfile:   TMA_PROP_IN_PROGRESS.sql  $
--       Date into PVCS   : $Date:   May 24 2010 09:15:50  $
--       Date fetched Out : $Modtime:   May 17 2010 11:16:54  $
--       PVCS Version     : $Revision:   1.1  $
--       Based on SCCS version :
--
--   Author : Aileen Heal
--
--   script to create theme TMA PROP IN PROGRESS
--   this script expect the view V_X_TMAPHS_PROPINPROG_SDOPT to have been created
...
Insert into USER_SDO_THEMES
 ...
 Values
   ('TMA PROP IN PROGRESS', 'V_X_TMAPHS_PROPINPROG_SDOPT', 'GEOM_PT', 
...
Insert into NM_THEMES_ALL
     ...
     SELECT nth_theme_id_seq.nextval, 'TMA PROP IN PROGRESS', 'V_X_TMAPHS_PROPINPROG_SDOPT', 
            NTH_PK_COLUMN, NTH_LABEL_COLUMN, 'V_X_TMAPHS_PROPINPROG_SDOPT',
...
BEGIN
   SELECT NTH_THEME_ID 
     INTO V_THEME_ID
     FROM NM_THEMES_ALL
    WHERE NTH_THEME_NAME = 'TMA PROP IN PROGRESS';
