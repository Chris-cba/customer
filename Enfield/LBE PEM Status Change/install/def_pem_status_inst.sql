...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/Enfield/LBE PEM Status Change/install/def_pem_status_inst.sql-arc   1.0   Oct 12 2012 12:21:42   Ian.Turnbull  $
--       Module Name      : $Workfile:   def_pem_status_inst.sql  $
--       Date into PVCS   : $Date:   Oct 12 2012 12:21:42  $
--       Date fetched Out : $Modtime:   Oct 05 2012 16:32:48  $
...
prompt
prompt About to install Defect/Pem Status Update using exor base : &exor_base
prompt
accept ok_res prompt "OK to Continue with this setting ? (Y/N) "

select decode(upper('&ok_res'),'Y','&exor_base'||'LBE PEM Status Change'||'&terminator'||
        'install'||'&terminator'||'def_pem_status_install','exit') run_file
from dual
/
