...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/colas/MAI_Themes/black_work_footway.sql-arc   3.0   Oct 18 2010 15:50:46   Ian.Turnbull  $
--       Module Name      : $Workfile:   black_work_footway.sql  $
--       Date into PVCS   : $Date:   Oct 18 2010 15:50:46  $
...
-- to create theme Black Work Footway

CREATE OR REPLACE FORCE VIEW V_X_DEF_BLACK_FOOTWAY 
...
--
 ...
 WHERE A.DEFECT_CODE = 'POFW'
 And a.DEFECT_ID = b.DEF_DEFECT_ID
/

insert into user_sdo_geom_metadata
    select 'V_X_DEF_BLACK_FOOTWAY', 'GEOLOC', DIMINFO, SRID 
...
select nth_theme_id_seq.nextval,'BLACK WORK FOOTWAY','V_MAI_DEFECTS','DEFECT_CODE = ''POFW''',
        'DEFECT_ID','DEFECT_ID','NM_ELEMENTS',null,null,null,'DEF_EASTING','DEF_NORTHING',null,
        'V_X_DEF_BLACK_FOOTWAY','DEFECT_ID',null,null,'GEOLOC','MAI','Y','SDO','I','S','N','N',
...
begin
   select nth_theme_id
     into v_new_theme_id
     from nm_themes_all
    where nth_feature_table = 'V_X_DEF_BLACK_FOOTWAY';
