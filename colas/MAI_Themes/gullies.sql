...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/colas/MAI_Themes/gullies.sql-arc   3.0   Oct 18 2010 15:50:48   Ian.Turnbull  $
--       Module Name      : $Workfile:   gullies.sql  $
--       Date into PVCS   : $Date:   Oct 18 2010 15:50:48  $
...
-- to create theme Gullies

CREATE OR REPLACE FORCE VIEW V_X_DEF_GULLIES
...
--
 ...
 WHERE A.DEFECT_CODE IN ('SMEL','BLCU')
 And a.DEFECT_ID = b.DEF_DEFECT_ID
/

insert into user_sdo_geom_metadata
    select 'V_X_DEF_GULLIES', 'GEOLOC', DIMINFO, SRID 
...
select nth_theme_id_seq.nextval,'GULLIES','V_MAI_DEFECTS',
        'DEFECT_CODE IN (''SMEL'',''BLCU'')',
        'DEFECT_ID','DEFECT_ID','NM_ELEMENTS',null,null,null,'DEF_EASTING','DEF_NORTHING',null,
        'V_X_DEF_GULLIES','DEFECT_ID',null,null,'GEOLOC','MAI','Y','SDO','I','S','N','N',
...
begin
   select nth_theme_id
     into v_new_theme_id
     from nm_themes_all
    where nth_feature_table = 'V_X_DEF_GULLIES';
...
values ('GULLIES','Bespoke theme created by Aileen Heal as part of BRS 2945',
        'V_X_DEF_GULLIES','GEOLOC',
