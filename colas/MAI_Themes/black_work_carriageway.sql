...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/colas/MAI_Themes/black_work_carriageway.sql-arc   3.0   Oct 18 2010 15:48:52   Ian.Turnbull  $
--       Module Name      : $Workfile:   black_work_carriageway.sql  $
--       Date into PVCS   : $Date:   Oct 18 2010 15:48:52  $
--       Date fetched Out : $Modtime:   Oct 18 2010 14:51:52  $
...
-- to create theme Black Work carriageway

CREATE OR REPLACE FORCE VIEW V_X_DEF_BLACK_CARRIAGEWAY 
...
-- for theme Black Work Carriageway
--
 ...
 WHERE A.DEFECT_CODE = 'POCW'
 And a.DEFECT_ID = b.DEF_DEFECT_ID
/

insert into user_sdo_geom_metadata
    select 'V_X_DEF_BLACK_CARRIAGEWAY', 'GEOLOC', DIMINFO, SRID 
...
select nth_theme_id_seq.nextval,'BLACK WORK CARRIAGEWAY','V_MAI_DEFECTS','DEFECT_CODE = ''POCW''',
        'DEFECT_ID','DEFECT_ID','NM_ELEMENTS',null,null,null,'DEF_EASTING','DEF_NORTHING',null,
        'V_X_DEF_BLACK_CARRIAGEWAY','DEFECT_ID',null,null,'GEOLOC','MAI','Y','SDO','I','S','N','N',
...
begin
   select nth_theme_id
     into v_new_theme_id
     from nm_themes_all
    where nth_feature_table = 'V_X_DEF_BLACK_CARRIAGEWAY';
...
values ('BLACK WORK CARRIAGEWAY',
        'Bespoke theme created by Aileen Heal as part of BRS 2945',
        'V_X_DEF_BLACK_CARRIAGEWAY','GEOLOC',
