drop materialized view X_MV_BRISTOL_WATER_GEOME1;

create materialized view X_MV_BRISTOL_WATER_GEOME1 AS
SELECT
--
-----------------------------------------------------------------------------
--
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/customer/Bristol Water/GeoMeFeed/X_MV_BRISTOL_WATER_GEOME1.vw-arc   1.0   Apr 22 2013 09:46:42   Ian.Turnbull  $
--       Module Name      : $Workfile:   X_MV_BRISTOL_WATER_GEOME1.vw  $
--       Date into PVCS   : $Date:   Apr 22 2013 09:46:42  $
--       Date fetched Out : $Modtime:   Apr 08 2013 14:39:20  $
...
comment on materialized view X_MV_BRISTOL_WATER_GEOME1 IS
...
CREATE INDEX X_MV_BRISTOLWATER_GEOME1_INDX1 on X_MV_BRISTOL_WATER_GEOME1(POS_LONG)
/

CREATE INDEX X_MV_BRISTOLWATER_GEOME1_INDX2 on X_MV_BRISTOL_WATER_GEOME1(POS_LAT)
/

CREATE OR REPLACE VIEW X_V_BRISTOL_WATER_GEOME AS SELECT * FROM X_MV_BRISTOL_WATER_GEOME1
/