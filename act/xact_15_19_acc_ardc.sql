...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)xact_15_19_acc_ardc.sql	1.1 03/14/05
--       Module Name      : xact_15_19_acc_ardc.sql
--       Date into SCCS   : 05/03/14 23:10:40
...
--
   l_rec_avs.avs_sql              := 'select a_value from dual -- @(#)xact_15_19_acc_ardc.sql	1.1 03/14/05'
                          ||CHR(10)||'WHERE '
                          ||CHR(10)||'a_value NOT IN ('||nm3flx.string('1')||','||nm3flx.string('2')||','||nm3flx.string('4')||')'
                          ||CHR(10)||'OR'
                          ||CHR(10)||'(a_value = '||nm3flx.string('1')
                          ||CHR(10)||' AND accdisc.get_attr_value(item_id,'||nm3flx.string('AWEA')||','||nm3flx.string('ACC')||') NOT IN ('||nm3flx.string('2')||','||nm3flx.string('3')||','||nm3flx.string('4')||')'
                          ||CHR(10)||')'
                          ||CHR(10)||'OR'
                          ||CHR(10)||'(a_value IN ('||nm3flx.string('2')||','||nm3flx.string('4')||')'
                          ||CHR(10)||' AND accdisc.get_attr_value(item_id,'||nm3flx.string('AWEA')||','||nm3flx.string('ACC')||') NOT IN ('||nm3flx.string('1')||')'
                          ||CHR(10)||')';
--
