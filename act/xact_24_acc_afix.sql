...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)xact_24_acc_afix.sql	1.1 03/14/05
--       Module Name      : xact_24_acc_afix.sql
--       Date into SCCS   : 05/03/14 23:10:44
...
--
   l_rec_avs.avs_sql              := 'select DECODE(accdisc.get_attr_value(item_id,'||nm3flx.string('ATPE')||','||nm3flx.string('ACC')||')'
                          ...
                          ||CHR(10)||'             ) the_value -- @(#)xact_24_acc_afix.sql	1.1 03/14/05'
                          ||CHR(10)||' from  dual';
--
