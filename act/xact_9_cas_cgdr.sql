...
--   SCCS Identifiers :-
--
--       sccsid           : @(#)xact_9_cas_cgdr.sql	1.1 03/14/05
--       Module Name      : xact_9_cas_cgdr.sql
--       Date into SCCS   : 05/03/14 23:10:47
...
--
   l_rec_avs.avs_sql              := 'select a_value from dual -- @(#)xact_9_cas_cgdr.sql	1.1 03/14/05'
                          ||CHR(10)||'WHERE ('
                          ...
                          ||CHR(10)||' AND aia.aia_aat_id = '||nm3flx.string('VDGR')
                          ||CHR(10)||' AND aia.aia_ait_id = '||nm3flx.string('VEH')
                          ||CHR(10)||' AND aia.aia_value = a_value'
                          ||CHR(10)||'))'
