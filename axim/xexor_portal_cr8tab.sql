--   SCCS Identifiers :-
--
--       sccsid           : @(#)xexor_portal_cr8tab.sql	1.1 03/15/05
--       Module Name      : xexor_portal_cr8tab.sql
--       Date into SCCS   : 05/03/15 00:16:34
--       Date fetched Out : 07/06/06 14:37:33
--       SCCS Version     : 1.1
--
--
...
-----------------------------------------------------------------------------
DROP TABLE xexor_portal_categories CASCADE CONSTRAINTS
/

CREATE TABLE xexor_portal_categories
...
DROP TABLE xexor_portal_links CASCADE CONSTRAINTS
/

CREATE TABLE xexor_portal_links
...
ALTER TABLE xexor_portal_links
...
ALTER TABLE xexor_portal_links
 ...
 REFERENCES xexor_portal_categories (xpc_id)
 ON DELETE CASCADE
/
