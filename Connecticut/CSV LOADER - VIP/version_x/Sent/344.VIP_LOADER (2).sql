...
-- ###############################################################
--
--  File           : 344.VIP_LOADER.sql
--  Extracted from : ATLAS@ctdotsb.SGSPRDODB04
--  Extracted by   : ATLAS
--  At             : 12-JUN-2014 02:20:44
--
-- ###############################################################
--
...
--
   ...
   add_nlfc ('LAST_VIP_UPDATE',nm3type.c_date,Null,'N',25,Null);
--
...
--
   ...
   nm3ins.ins_nlfd (l_rec_nlfd);
--
   upd_nlcd ('ROAD_UNIQUE','VIP_LOADER.ROAD_UNIQUE');
   upd_nlcd ('ROUTE_SUFFIX','VIP_LOADER.ROUTE_SUFFIX_LETTER');
   upd_nlcd ('ROUTE_DIR','VIP_LOADER.ROUTE_DIR');
