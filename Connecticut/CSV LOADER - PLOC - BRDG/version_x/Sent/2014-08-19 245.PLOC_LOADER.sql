...
--
   ...
   add_nlfc ('ADMIN_UNIT',nm3type.c_varchar,10,'Y',3,Null);
   add_nlfc ('START_DATE',nm3type.c_date,Null,'N',4,'DD/MM/YYYY');
   add_nlfc ('XSP',nm3type.c_varchar,4,'N',5,Null);
   add_nlfc ('PROJECT_NUMBER',nm3type.c_varchar,10,'Y',6,Null);
   add_nlfc ('PROJECT_TYPE',nm3type.c_varchar,10,'N',7,Null);
   add_nlfc ('PROJOECT_END_DATE',nm3type.c_varchar,4,'N',8,Null);
   add_nlfc ('PROJECT_DIRECTION',nm3type.c_varchar,2,'N',9,Null);
   add_nlfc ('PROJECT_SECTION',nm3type.c_varchar,50,'N',10,Null);
--
