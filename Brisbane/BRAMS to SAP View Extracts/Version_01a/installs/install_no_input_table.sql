/*
	...
	file: install.sql
	Author: JMM
	UPDATE01:	Original, 2014.04.14, JMM
*/
...
-- Spool to Logfile
--
define logfile1='XBCC_SAP_SYNC_&log_extension'
define logfile2='XBCC_SAP_SYNC_2_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
BEGIN
 ...
 --
 /*   -- Removed due to some systems on 4400 some on 4500
