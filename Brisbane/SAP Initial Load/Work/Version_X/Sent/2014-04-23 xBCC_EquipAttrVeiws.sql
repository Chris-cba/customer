...
Create or replace procedure xBCC_Equip_Attr_Views(s_primary_view in varchar2 default '%') as
	...
	cursor c_assets is select * from  xBCC_EAV_Input where primary_view like s_primary_view;
...
from (
     ...
     FROM (
		...
		##X_SECT##  -- Moved here for speed reasons in the QO
        )  , V_NM_NLT_##ROUTE_TYPE##_##ROUTE_TYPE##_SDO_DT rt
        Where 1=1     
		and ##MED## rt.ne_id =  mem_nm_ne_id_in
        ) a
       -- ,  V_NM_NLT_##ROUTE_TYPE##_##ROUTE_TYPE##_SDO_DT sdo
       -- Where 1=1       
       -- and ##MED## sdo.ne_id =  NETWORK_PRIMARY_ID
