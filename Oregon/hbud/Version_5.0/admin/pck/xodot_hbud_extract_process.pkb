...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //new_vm_latest/archives/customer/Oregon/hbud/Version_5.0/admin/pck/xodot_hbud_extract_process.pkb-arc   1.0   Jan 15 2016 19:26:36   Sarah.Williams  $
        ...
        where
            R.SCNS_HWY_EA_NO in
                (
                      ...
                      where crew = nm3net.get_ne_unique(
                     -- 1280740)
                        p_ne_id)
                )
    );
