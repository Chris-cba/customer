...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //new_vm_latest/archives/customer/Oregon/hbud/Version_9.0/admin/pck/xodot_hbud_extract_process.pkb-arc   1.0   Jan 15 2016 19:29:16   Sarah.Williams  $
  ...
  IF  p_asset_type = 'RDGM' THEN
        ...
        v_query := 'select sum (least(r.nm_end_mp, sm.nm_end_mp) - greatest(r.nm_begin_mp, sm.nm_begin_mp)) 
          from 
                ...
                and r.nm_end_mp >= sm.nm_begin_mp 
                and r.nm_begin_mp <= sm.nm_end_mp';
