...
SELECT
	...
	(NVL(PREVIOUS_INCR_MILEAGE ,0) - NVL(POST_INCR_MILEAGE,0)) CHANGE_INCREASING,
	(NVL(PREVIOUS_DECR_MILEAGE ,0) - NVL(POST_DECR_MILEAGE,0)) CHANGE_DECREASING,
