CREATE OR REPLACE PACKAGE BODY xodot_bike_ped
AS
--
-----------------------------------------------------------------------------
--
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/customer/Oregon/Bike_Ped/admin/pck/xodot_bike_ped.pkb-arc   3.0   Sep 21 2010 14:28:30   Ian.Turnbull  $
--       Module Name      : $Workfile:   xodot_bike_ped.pkb  $
--       Date into PVCS   : $Date:   Sep 21 2010 14:28:30  $
--       Date fetched Out : $Modtime:   Sep 21 2010 14:24:24  $
