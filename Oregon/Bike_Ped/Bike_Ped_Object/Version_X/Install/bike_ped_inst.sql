...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //new_vm_latest/archives/customer/Oregon/Bike_Ped/Bike_Ped_Object/Version_X/Install/bike_ped_inst.sql-arc   1.0   Jan 15 2016 16:39:56   Sarah.Williams  $
--       Module Name      : $Workfile:   bike_ped_inst.sql  $
--       Date into PVCS   : $Date:   Jan 15 2016 16:39:56  $
--       Date fetched Out : $Modtime:   Sep 21 2010 21:24:30  $
...
prompt
prompt About to install Bike Ped reporting objects using exor base : &exor_base
prompt
accept ok_res prompt "OK to Continue with this setting ? (Y/N) "

select decode(upper('&ok_res'),'Y','&exor_base'||'bike_ped'||'&terminator'||
        'install'||'&terminator'||'bike_ped_install','exit') run_file
from dual
/
