CREATE OR REPLACE VIEW v_nm_grad AS
SELECT samp_id
                    ...
                    FROM (
                        ...
                        FROM (
                            SELECT c.iit_ne_id sample_iit_ne_id
                                , c.iit_chr_attrib27 samp_id 
                                , a.ne_unique
                                , DECODE (b.nm_cardinality, 1, b.nm_slk + (GREATEST (NVL (d.nm_begin_mp, 0), b.nm_begin_mp)) - b.nm_begin_mp, 
                                        b.nm_slk + (b.nm_end_mp - LEAST (NVL (d.nm_end_mp, 9999), b.nm_end_mp)))nm_slk
                                , DECODE (b.nm_cardinality, 1, b.nm_end_slk - (b.nm_end_mp - LEAST (NVL (d.nm_end_mp, 9999), b.nm_end_mp)),
                                        b.nm_slk + (b.nm_end_mp - GREATEST (NVL (d.nm_begin_mp, 0), b.nm_begin_mp))) nm_end_slk
                                , b.nm_ne_id_of ne_id_of
                                , GREATEST (NVL (d.nm_begin_mp, 0), b.nm_begin_mp) nm_begin_mp
                                , LEAST (NVL (d.nm_end_mp, 999), b.nm_end_mp) nm_end_mp
                            FROM nm_elements_all a
                                , nm_members_all b
                                , nm_inv_items_all c
                                , nm_members_all d
                            WHERE a.ne_id = b.nm_ne_id_in
                                ...
                                AND d.nm_end_date IS NULL
                                AND d.nm_ne_id_of = b.nm_ne_id_of
                                AND b.nm_begin_mp < d.nm_end_mp
                                AND b.nm_end_mp > d.nm_begin_mp))
                    WHERE slk = nm_slk) b
