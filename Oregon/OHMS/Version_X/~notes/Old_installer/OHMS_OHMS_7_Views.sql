...
--------------------------------------------------------
--  DDL for View V_OHMS_7_581_OHMS_SAMPLE_ID
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_OHMS_7_581_HPMS_SAMPLE_ID" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_TEXT", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
...
;
--------------------------------------------------------
--  DDL for View V_OHMS_7_744_CURVES_B
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_OHMS_7_744_CURVES_B" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
...
;
--------------------------------------------------------
--  DDL for View V_OHMS_7_746_CURVES_D
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_OHMS_7_746_CURVES_D" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
...
;
--------------------------------------------------------
--  DDL for View V_OHMS_7_747_CURVES_E
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_OHMS_7_747_CURVES_E" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
...
;
--------------------------------------------------------
--  DDL for View V_OHMS_7_748_CURVES_F
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_OHMS_7_748_CURVES_F" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
