DROP MATERIALIZED VIEW TRANSINFO.V_NM_NBI104_OUTER_MV_NW;
CREATE MATERIALIZED VIEW TRANSINFO.V_NM_NBI104_OUTER_MV_NW 
TABLESPACE HIGHWAYS
PCTUSED    0
PCTFREE    10
INITRANS   2
...
WITH PRIMARY KEY
AS 
/* Formatted on 12/9/2010 5:08:58 PM (QP5 v5.115.810.9015) */
SELECT   IIT_NE_ID,
         IIT_INV_TYPE,
         IIT_PRIMARY_KEY,
         IIT_START_DATE,
...
COMMENT ON MATERIALIZED VIEW TRANSINFO.V_NM_NBI104_OUTER_MV_NW IS 'snapshot table for snapshot TRANSINFO.V_NM_NBI104_OUTER_MV_NW';
