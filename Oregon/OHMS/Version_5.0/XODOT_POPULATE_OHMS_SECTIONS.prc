...
CURSOR CUR_501 IS 
SELECT * FROM V_HPMS_FINAL_7_501_F_System;

CURSOR CUR_502 IS 
SELECT * FROM V_HPMS_FINAL_7_502_Urban_Code;

CURSOR CUR_503 IS 
SELECT * FROM V_HPMS_FINAL_7_503_Facility_Ty;

CURSOR CUR_504 IS 
SELECT * FROM V_HPMS_FINAL_7_504_Structure_T;

CURSOR CUR_507 IS 
SELECT * FROM V_HPMS_FINAL_7_507_Through_Lan;

CURSOR CUR_508 IS 
SELECT * FROM V_HPMS_FINAL_7_508_HOV_Type;

CURSOR CUR_509 IS 
SELECT * FROM V_HPMS_FINAL_7_509_HOV_LANES;

CURSOR CUR_510 IS 
SELECT * FROM V_HPMS_FINAL_7_510_Urban_Sub;

CURSOR CUR_512 IS 
SELECT * FROM V_HPMS_FINAL_7_512_Turn_Lanes_;

CURSOR CUR_513 IS 
SELECT * FROM V_HPMS_FINAL_7_513_Turn_Lanes_;

CURSOR CUR_514 IS 
SELECT * FROM V_HPMS_FINAL_7_514_SPEED_LIMIT;

CURSOR CUR_521 IS 
SELECT * FROM V_HPMS_FINAL_7_521_AADT;

CURSOR CUR_522 IS 
SELECT * FROM V_HPMS_FINAL_7_522_AADT_Single;

CURSOR CUR_523 IS 
SELECT * FROM V_HPMS_FINAL_7_523_Pct_Peak_Si;

CURSOR CUR_524 IS 
SELECT * FROM V_HPMS_FINAL_7_524_AADT_Combin;

CURSOR CUR_525 IS 
SELECT * FROM V_HPMS_FINAL_7_525_Pct_Peak_Co;

CURSOR CUR_526 IS 
SELECT * FROM V_HPMS_FINAL_7_526_K_Factor;

CURSOR CUR_527 IS 
SELECT * FROM V_HPMS_FINAL_7_527_Dir_Factor;

CURSOR CUR_528 IS 
SELECT * FROM V_HPMS_FINAL_7_528_Future_AADT;

CURSOR CUR_531 IS 
SELECT * FROM V_HPMS_FINAL_7_531_Number_Sign;

CURSOR CUR_532 IS 
SELECT * FROM V_HPMS_FINAL_7_532_Stop_Signs;

CURSOR CUR_533 IS 
SELECT * FROM V_HPMS_FINAL_7_533_At_Grade_Ot;

CURSOR CUR_534 IS 
SELECT * FROM V_HPMS_FINAL_7_534_Lane_Width;

CURSOR CUR_535 IS 
SELECT * FROM V_HPMS_FINAL_7_535_Median_Type;

CURSOR CUR_536 IS 
SELECT * FROM V_HPMS_FINAL_7_536_Median_Widt;

CURSOR CUR_537 IS 
SELECT * FROM V_HPMS_FINAL_7_537_Shoulder_Ty;

CURSOR CUR_538 IS 
SELECT * FROM V_HPMS_FINAL_7_538_Shoulder_Wi;

CURSOR CUR_539 IS 
SELECT * FROM V_HPMS_FINAL_7_539_Shoulder_Wi;

CURSOR CUR_540 IS 
SELECT * FROM V_HPMS_FINAL_7_540_Peak_Park_R;

CURSOR CUR_544 IS 
SELECT * FROM V_HPMS_FINAL_7_544_Terrain_Typ;

CURSOR CUR_549 IS 
SELECT * FROM V_HPMS_FINAL_7_549_Surface_Typ;

CURSOR CUR_556 IS 
SELECT * FROM V_HPMS_FINAL_7_556_LAST_OVERLA;

CURSOR CUR_557 IS 
SELECT * FROM V_HPMS_FINAL_7_557_Thickness_R;

CURSOR CUR_558 IS 
SELECT * FROM V_HPMS_FINAL_7_558_Thickness_F;

CURSOR CUR_565 IS 
SELECT * FROM V_HPMS_FINAL_7_565_Oregon_Frei;

CURSOR CUR_566 IS 
SELECT * FROM V_HPMS_FINAL_7_566_Region_Dist;

CURSOR CUR_567 IS 
SELECT * FROM V_HPMS_FINAL_7_567_PMS;

CURSOR CUR_743 IS 
SELECT * FROM V_HPMS_FINAL_7_743_CURVES_A;

CURSOR CUR_745 IS 
SELECT * FROM V_HPMS_FINAL_7_745_CURVES_C;
...
******************************************************/
    BEGIN
        ...
        t_data_item_var     := 'Region_District';
        t_item_descr     := 'Region_District';
