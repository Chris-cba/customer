...
--------------------------------------------------------
--  DDL for View V_OHMS_7_610_611_P_LANES
--------------------------------------------------------
CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_OHMS_7_610_611_P_LANES" as
...
with TLANES as
  (  
   ...
   group by ROUTE_ID, VALUE_NUMERIC 
  ...
  select 
    ...
    , SECTION_LENGTH
    , VALUE_NUMERIC
    , ROUND(VALUE_NUMERIC * 0.5) PEAK_LANES
    , value_numeric - round(VALUE_NUMERIC * 0.5) C_Peak_lanes
...
;
--------------------------------------------------------
--  DDL for View V_HPMS_7_744_CURVES_B
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_HPMS_7_744_CURVES_B" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
            ...
            , nm_end_slk END_POINT
            , nm_end_slk-nm_slk SECTION_LENGTH
            , curv_curve_b_len VALUE_NUMERIC
            , curv_samp_id COMMENTS
            , ne_id_of, nm_begin_mp, nm_end_mp
        FROM (
            SELECT   
            ...
            FROM (
                    SELECT 
                        ...
                        , greatest(a.nm_begin_mp, b.nm_begin_mp) nm_begin_mp
                        , least(a.nm_end_mp, b.nm_end_mp) nm_end_mp
                        , a.curve_b_len curv_curve_b_len
                        , a.samp_id curv_samp_id
                    FROM 
                          --v_nm_curv_nw a
						  v_nm_curv_OHMS a
...
;
--------------------------------------------------------
--  DDL for View V_HPMS_7_746_CURVES_D
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_HPMS_7_746_CURVES_D" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
            ...
            , nm_end_slk END_POINT
            , nm_end_slk-nm_slk SECTION_LENGTH
            , curv_curve_d_len VALUE_NUMERIC
            , curv_samp_id COMMENTS
            , ne_id_of, nm_begin_mp, nm_end_mp
        FROM (
            SELECT   
            ...
            FROM (
                    SELECT 
                        ...
                        , greatest(a.nm_begin_mp, b.nm_begin_mp) nm_begin_mp
                        , least(a.nm_end_mp, b.nm_end_mp) nm_end_mp
                        , a.curve_d_len curv_curve_d_len
                        , a.samp_id curv_samp_id
                    FROM 
                          --v_nm_curv_nw a
						  v_nm_curv_OHMS a
...
;
--------------------------------------------------------
--  DDL for View V_HPMS_7_747_CURVES_E
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_HPMS_7_747_CURVES_E" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
            ...
            , nm_end_slk END_POINT
            , nm_end_slk-nm_slk SECTION_LENGTH
            , curv_curve_e_len VALUE_NUMERIC
            , curv_samp_id COMMENTS
            , ne_id_of, nm_begin_mp, nm_end_mp
        FROM (
            SELECT   
            ...
            FROM (
                    SELECT 
                        ...
                        , greatest(a.nm_begin_mp, b.nm_begin_mp) nm_begin_mp
                        , least(a.nm_end_mp, b.nm_end_mp) nm_end_mp
                        , a.curve_e_len curv_curve_e_len
                        , a.samp_id curv_samp_id
                    FROM 
                          --v_nm_curv_nw a
						  v_nm_curv_OHMS a
...
;
--------------------------------------------------------
--  DDL for View V_HPMS_7_748_CURVES_F
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_HPMS_7_748_CURVES_F" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
            ...
            , nm_end_slk END_POINT
            , nm_end_slk-nm_slk SECTION_LENGTH
            , curv_curve_f_len VALUE_NUMERIC
            , curv_samp_id COMMENTS
            , ne_id_of, nm_begin_mp, nm_end_mp
        FROM (
            SELECT   
            ...
            FROM (
                    SELECT 
                        ...
                        , greatest(a.nm_begin_mp, b.nm_begin_mp) nm_begin_mp
                        , least(a.nm_end_mp, b.nm_end_mp) nm_end_mp
                        , a.curve_f_len curv_curve_f_len
                        , a.samp_id curv_samp_id
                    FROM 
                          --v_nm_curv_nw a
						  v_nm_curv_OHMS a
...
;
--------------------------------------------------------
--  DDL for View V_HPMS_7_749_GRADES_A
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_HPMS_7_749_GRADES_A" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
...
;
--------------------------------------------------------
--  DDL for View V_HPMS_7_750_GRADES_B
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_HPMS_7_750_GRADES_B" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
...
;
--------------------------------------------------------
--  DDL for View V_HPMS_7_751_GRADES_C
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_HPMS_7_751_GRADES_C" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
...
;
--------------------------------------------------------
--  DDL for View V_HPMS_7_752_GRADES_D
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_HPMS_7_752_GRADES_D" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
...
;
--------------------------------------------------------
--  DDL for View V_HPMS_7_753_GRADES_E
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_HPMS_7_753_GRADES_E" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
...
;
--------------------------------------------------------
--  DDL for View V_HPMS_7_754_GRADES_F
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "TRANSINFO"."V_HPMS_7_754_GRADES_F" ("ROUTE_ID", "BEGIN_POINT", "END_POINT", "SECTION_LENGTH", "VALUE_NUMERIC", "COMMENTS", "NE_ID_OF", "NM_BEGIN_MP", "NM_END_MP") AS 
  SELECT
