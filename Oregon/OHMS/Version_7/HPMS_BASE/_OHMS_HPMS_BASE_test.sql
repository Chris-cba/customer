...
Insert into HPMS_MAPPING (HM_ID,HM_HCL_ID,HM_HDI_ID,HM_ITEM,HM_ITEM_VALUE,HM_ITEM_ATTRIBUTE,HM_ITEM_WHERE,HM_ITEM_FUNCTION,HM_XSP,HM_ITEM_TYPE,HM_ITEM_FORMULA,HM_JOIN_TYPE,HM_OUTPUT,HM_ROLLUP,HM_CURSOR_PROCESS) values (7156,509,568,'HPMS','SAMP_ID',null,null,'VALUE',null,'ASSET',null,'I','Y',null,'Y');
Insert into HPMS_MAPPING (HM_ID,HM_HCL_ID,HM_HDI_ID,HM_ITEM,HM_ITEM_VALUE,HM_ITEM_ATTRIBUTE,HM_ITEM_WHERE,HM_ITEM_FUNCTION,HM_XSP,HM_ITEM_TYPE,HM_ITEM_FORMULA,HM_JOIN_TYPE,HM_OUTPUT,HM_ROLLUP,HM_CURSOR_PROCESS) values (7156,508,568,'HPMS',null,'DATA_YR','=(SELECT DATA_YEAR() FROM DUAL)','VALUE',null,'ASSET',null,'I',null,null,null);
