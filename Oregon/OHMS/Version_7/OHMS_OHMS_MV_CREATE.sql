...
AND IIT_X_SECT LIKE 'LN%'
;
CREATE INDEX OHMS_TMP_7_610_RDGM_IDX ON OHMS_TMP_7_610_RDGM(ne_id_of);
...
CREATE INDEX OHMS_TMP_RTE_7_610_RDGM_IDX ON OHMS_TMP_RTE_7_610_RDGM(NE_UNIQUE);
...
CREATE TABLE OHMS_tmp_seg_7_610_rdgm AS
    ...
    WHERE nm_end_slk > -1;
        ...
        CREATE INDEX OHMS_tmp_seg_7_610_rdgm_idx ON OHMS_tmp_seg_7_610_rdgm
        (NE_UNIQUE);
...
CREATE TABLE OHMS_TMP_DETAIL_7_610_RDGM AS
    ...
    WHERE 1=1
        ...
        AND l.nm_end_slk > a.nm_slk
        ;
DROP TABLE v_nm_rdgm610_count_mv_nw;
...
AND IIT_X_SECT LIKE 'LN%'
;
CREATE INDEX OHMS_TMP_7_611_RDGM_IDX ON OHMS_TMP_7_611_RDGM(ne_id_of);
...
CREATE INDEX OHMS_TMP_RTE_7_611_RDGM_IDX ON OHMS_TMP_RTE_7_611_RDGM(NE_UNIQUE);
...
CREATE TABLE OHMS_tmp_seg_7_611_rdgm AS
    ...
    WHERE nm_end_slk > -1;
        ...
        CREATE INDEX OHMS_tmp_seg_7_611_rdgm_idx ON OHMS_tmp_seg_7_611_rdgm
        (NE_UNIQUE);
