...
/* ************************************************************
	Object:		xodot_signs_task_list_row, xodot_signs_task_list, xodot_signs_asset_op
	Purpose:	Used as interface items between the Signs Broker and the xodot_signs_api
	Notes:		
...
DECLARE
   ...
   i_count  number;
BEGIN
   name_array(2) := 'xodot_signs_task_list_row';
   name_array(1) := 'xodot_signs_task_list';
