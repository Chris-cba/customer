...
*/
	g_version varchar(12)				:= '01_12';
/*
	The functions and procedures found in this package is intended to be used from the Sign_Broker.  The package contains an interface to TI that the broker can access, many calls are a front end for existing TI Api calls.  
...
function get_version return varchar2 is
	/*
	Used for: The broker to see if there is an error with this package, future versions may use the version number.
	*/
	begin
		return g_version;
end get_version;
...
/*
	Used for: operations to the asset type SNML, Sign Maintenance Log.  This is need so that special error logging can occur
*/
...
/*
	Used for:  Obtaining List of values for the Broker that are stored as assets in TI
*/
...
/*
	Used for:  Obtaining List of values for the Broker that are stored as Domains in TI
*/
	n_count number := 0;
	s_info xodot_signs_asset_op := xodot_signs_asset_op(null,null,null);
	begin
...
/*
	Used for:  Obtaining the children assets of an installation
*/
	begin
		open ref_cur for
...
/*
	Used for:  Obtaining List of values for the Broker that are stored in the reports schema for TI, May also be used for more complicated reporting in the TI schema
*/
	s_sql  varchar2(2000);
