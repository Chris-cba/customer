...
/* ************************************************************
	Object:		log_exception, log_status
	Purpose:	To Asynchronously log  broker errors/ outcome into the Report schema error and log table
	Notes:		Expected to only be used by the Signs Broker Program
...
************************************************************* */
 ...
 procedure log_exception(s_ne_id varchar2,s_install_id varchar2,s_statehwy varchar2,n_mp number,s_error_type varchar2,s_sync_error varchar2) is
  r_err reports.xsign_except%rowtype;
...
DROP PUBLIC SYNONYM xodot_signs_logging;

CREATE OR REPLACE PUBLIC SYNONYM xodot_signs_logging FOR TRANSINFO.xodot_signs_logging;